...
*version* [st-alpha-0.8.2.diff](https://st.suckless.org/patches/alpha/st-alpha-0.8.2.diff)
...
*version* [st-anysize-0.8.4.diff](https://st.suckless.org/patches/anysize/st-anysize-0.8.4.diff)
...
*version* [st-blinking_cursor-20211116-2f6e597.diff](https://st.suckless.org/patches/blinking_cursor/st-blinking_cursor-20211116-2f6e597.diff)
...
*version* [st-font2-0.8.5.diff](https://st.suckless.org/patches/font2/st-font2-0.8.5.diff)
...
*version* [st-w3m-0.8.3.diff](https://st.suckless.org/patches/w3m/st-w3m-0.8.3.diff)
...
*version* [st-scrollback-20210507-4536f46.diff](https://st.suckless.org/patches/scrollback/st-scrollback-20210507-4536f46.diff)
*version* [st-scrollback-mouse-20220127-2c5edf2.diff](https://st.suckless.org/patches/scrollback/st-scrollback-mouse-20220127-2c5edf2.diff)

Scroll back through terminal output using Shift+{PageUp, PageDown}.


- [hidecursor](https://st.suckless.org/patches/hidecursor/)
*version* [hidecursor](https://st.suckless.org/patches/hidecursor/st-hidecursor-0.8.3.diff)
...
*version* [st-rightclickpaste-0.8.2.diff](https://st.suckless.org/patches/rightclickpaste/st-rightclickpaste-0.8.2.diff)
